    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          ...
          <img src="/assets/uploads/podcast-quote.jpg" alt="Listening is not the same as hearing, and hearing is not the same as listening. Pauline Oliveros" style="height:500px">
        </div>
